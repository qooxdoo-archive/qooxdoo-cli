  ...
  members: {
    ...
    process: async function() {
      ...
      try {
        ...
        throw new qxcli.Utils.UserError("No Qooxdoo application directory!")
      }
      ...
      if( ! new_version ) {
        throw new qxcli.Utils.UserError("Cannot parse version number in Manifest. Please provide a valid version in the x.y.z format.");
      }
