  ...
  members: {
    ...
    getLibraryVersion : async function(libPath)
    {
      ...
      try{
        ...
        throw new Error(`No valid version data in manifest.`);
      }
      if( ! semver.valid(version) ) {
        throw new Error(`Manifest at ${manifestPath} contains invalid version number "${version}". Please use a semver compatible version.`);
      }
      return version;
    },
